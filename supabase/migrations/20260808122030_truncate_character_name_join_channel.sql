-- #94: truncate character names to 20 chars inside join_channel so the
-- CHECK constraint added by limit_character_name_20 cannot be violated by
-- callers that bypass the UI's maxLength.

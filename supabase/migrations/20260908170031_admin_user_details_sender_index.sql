...
--
-- Standalone file: the CLI runs `db reset` as a pipeline, and CREATE INDEX
-- CONCURRENTLY cannot run inside one, so it must be the only statement in its
-- own migration (matches 20260905175441).

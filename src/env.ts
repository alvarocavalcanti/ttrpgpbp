...
const envSchema = z.object({
  ...
  // Optional so clone-and-deploy builds work; unset renders a generic line
  // and omits the contact email.
  VITE_CONTROLLER_NAME: z.string().min(1).optional().or(z.literal('')),
  VITE_CONTROLLER_EMAIL: z.string().email().optional().or(z.literal('')),
})

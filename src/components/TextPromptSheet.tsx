      ...
      >
        <div>
          ...
          <input
            ...
            className="bg-white dark:bg-gray-800 mt-1 block w-full min-h-11 rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-3 py-2 border"
          />

      ...
      <div className="fixed inset-x-0 bottom-0 max-h-[80vh] flex flex-col rounded-t-2xl bg-white dark:bg-gray-800 shadow-xl">
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 dark:border-gray-700">
          ...
          <button
            ...
            className="p-1 text-gray-400 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-400 rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-500"
          >

...
// danger-styled confirm button. Closes on backdrop tap or Escape. Focus is
// managed by useFocusTrap — it lands on the first control (Cancel, the safe
// choice for destructive confirmations) and stays trapped while open.

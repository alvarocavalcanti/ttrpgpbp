        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            {env.VITE_GA_MEASUREMENT_ID && (
              <li>
                <span className="font-semibold">Google Analytics</span> — page-view statistics so we understand which screens are used. The app sends the page address only, never your search terms, messages, or dice rolls. Google Analytics also records standard browser and device details, session counts, and an approximate location derived from your IP address. It is only enabled where the operator has configured it and obtained any consent the law requires.
              </li>
            )}
            {env.VITE_SENTRY_DSN && (
              <li>

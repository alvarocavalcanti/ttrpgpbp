  ...
  return (
    <div className="flex h-[100dvh] overflow-hidden bg-white dark:bg-surface-800 relative">
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-surface-50 dark:bg-surface-900 border-r border-surface-200 dark:border-surface-700">
        ...
        {messagesError && (
          <div className="px-4 py-2 bg-red-50 dark:bg-red-950 border-b border-red-200 dark:border-red-800 text-red-700 dark:text-red-400 text-sm flex items-center justify-between gap-3" role="alert">
            ...
            <button
              ...
              className="flex-shrink-0 inline-flex items-center justify-center min-h-11 rounded-md border border-red-300 dark:border-red-700 px-2 py-1 font-medium text-red-700 dark:text-red-300 hover:bg-red-100 dark:hover:bg-red-900 disabled:opacity-50"
            >
              Retry
            </button>
          </div>
        ...
        {catchUpError && (
          <div className="px-4 py-2 bg-red-50 dark:bg-red-950 border-b border-red-200 dark:border-red-800 text-red-700 dark:text-red-400 text-sm flex items-center justify-between gap-3" role="alert">
            <span>Could not load X-Card alerts. Try again.</span>
            <button
              type="button"
              onClick={retryCatchUp}
              aria-label="Retry loading X-Card alerts"
              className="flex-shrink-0 inline-flex items-center justify-center min-h-11 rounded-md border border-red-300 dark:border-red-700 px-2 py-1 font-medium text-red-700 dark:text-red-300 hover:bg-red-100 dark:hover:bg-red-900"
            >
              Retry
            </button>
          </div>

                  ...
                  <li key={npc.id} className="flex items-center space-x-3 p-2 rounded-md bg-gray-50 dark:bg-gray-900">
                    ...
                    {editingId === npc.id ? (
                      <div className="flex-1 min-w-0 flex items-center space-x-2">
                        ...
                        />
                        <button type="button" onClick={handleRename} className="relative text-xs text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-200 font-medium shrink-0 after:content-[''] after:absolute after:-inset-2.5">
                          Save
                        </button>
                      </div>
                    ) : (
                    ...
                    <div className="flex items-center space-x-1 flex-shrink-0">
                      {editingId === npc.id ? (
                        <button type="button" onClick={() => setEditingId(null)} className="relative p-1.5 text-gray-400 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-400 after:content-[''] after:absolute after:-inset-2.5" aria-label="Cancel rename">
                        ...
                        <button
                          ...
                          className="relative p-1.5 text-gray-400 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 after:content-[''] after:absolute after:-inset-2.5"
                      ...
                      <label className="relative p-1.5 text-gray-400 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 cursor-pointer disabled:opacity-50 after:content-[''] after:absolute after:-inset-2.5" title="Upload portrait">
                        <input
                          type="file"
                          accept="image/*"
                      ...
                      <button
                        ...
                        className="relative p-1.5 text-gray-400 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 after:content-[''] after:absolute after:-inset-2.5"
            ...
            <div className="border-t border-gray-100 dark:border-gray-700 pt-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  type="button"
                  onClick={handleAdd}
                  className="shrink-0 inline-flex min-h-11 items-center justify-center px-3 py-1.5 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >
                  Add
                </button>
              </div>

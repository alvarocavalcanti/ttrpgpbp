                ...
                {npcs.map(npc => (
                  <li key={npc.id} className="flex items-center space-x-3 p-2 rounded-md bg-gray-50 dark:bg-gray-900">
                    ...
                    <div className="flex items-center space-x-1 flex-shrink-0">
                      {editingId === npc.id ? (
                        <button type="button" onClick={() => setEditingId(null)} className="h-11 w-11 flex items-center justify-center text-gray-400 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-400" aria-label="Cancel rename">
                        ...
                        <button
                          ...
                          className="h-11 w-11 flex items-center justify-center text-gray-400 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400"
                      ...
                      <button
                        ...
                        className="h-11 w-11 flex items-center justify-center text-gray-400 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400"

          ...
          {isEditing ? (
            <div className="space-y-2 mt-2">
              <textarea
                ...
                className="w-full text-surface-900 dark:text-surface-100 border-amber-300 dark:border-amber-700 rounded-md shadow-sm focus:ring-amber-500 dark:focus:ring-amber-400 focus:border-amber-500 dark:focus:border-amber-400 sm:text-sm bg-white dark:bg-surface-800 p-2"
                rows={4}
              />

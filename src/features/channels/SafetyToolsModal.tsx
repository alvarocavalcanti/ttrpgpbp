    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-600 bg-opacity-75 dark:bg-gray-900 dark:bg-opacity-80">
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100">Safety Tools</h3>
          <button
            type="button"
            onClick={onClose}
        ...
        {safetyToolsUrl && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="block mb-4 px-4 py-2.5 rounded-md bg-indigo-50 dark:bg-indigo-950 border border-indigo-200 dark:border-indigo-800 text-sm font-medium text-indigo-700 dark:text-indigo-300 hover:bg-indigo-100 dark:hover:bg-indigo-900 transition-colors"
          >
        ...
        {loading ? (
          ...
          <div className="space-y-6">
            <div>
              <h4 className="text-sm font-semibold text-gray-900 dark:text-gray-100 uppercase tracking-wider mb-2">Lines</h4>
            ...
            <div>
              <h4 className="text-sm font-semibold text-gray-900 dark:text-gray-100 uppercase tracking-wider mb-2">Veils</h4>
              <p className="text-sm text-gray-500 dark:text-gray-400 whitespace-pre-wrap">
                {safetyTools?.veils
                  ? safetyTools.veils
            ...
            <div>
              <h4 className="text-sm font-semibold text-gray-900 dark:text-gray-100 uppercase tracking-wider mb-2">X-Card</h4>

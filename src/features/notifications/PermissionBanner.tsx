    ...
    <div className="bg-indigo-50 dark:bg-indigo-950 border border-indigo-200 dark:border-indigo-800 rounded-lg px-4 py-3 flex items-center justify-between gap-4 mx-4 md:mx-0 mt-6" role="region" aria-label="Notification permission">
      ...
      <div className="flex items-center gap-2 flex-shrink-0">
        <button
          ...
          className="inline-flex items-center min-h-11 px-3 py-1.5 bg-indigo-600 text-white text-sm font-medium rounded-md hover:bg-indigo-700 disabled:opacity-50"
        >
        ...
        <button
          ...
          className="inline-flex items-center min-h-11 px-3 py-1.5 text-gray-500 dark:text-gray-400 text-sm font-medium rounded-md hover:bg-indigo-100 dark:hover:bg-indigo-900"

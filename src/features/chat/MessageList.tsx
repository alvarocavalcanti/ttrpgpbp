      ...
      {hasMore && (
        <div className="flex justify-center py-2">
          <button
            ...
            className="min-h-11 px-4 py-2 text-xs font-medium text-primary-600 dark:text-primary-400 hover:text-primary-800 dark:hover:text-primary-200 disabled:opacity-50"
          >

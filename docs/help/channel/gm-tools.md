...
- **Tap an image to zoom** — any image in a message opens fullscreen: pinch or use the +/− buttons to zoom, drag to pan, and double-tap (or double-click) to fit it back on screen. Close with ✕ or Escape

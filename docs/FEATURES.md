...
- **Emoji reactions** — react to a message from the **Reactions** action; counts update live and toggle per user. Tapping a reaction shows **who reacted** without changing your own reaction (adding/removing stays in the Reactions action)
